...
#define ASF_IR_LIVENESS			0x00000400	//IR活体
	...
	******************************************************/
	MRESULT ASFDetectFacesEx(
		...
		LPASF_MultiFaceInfo	detectedFaces,						// [out] 检测到的人脸信息
		ASF_DetectModel		detectModel = ASF_DetectModel::ASF_DETECT_MODEL_RGB	// [in]	预留字段，当前版本使用默认参数即可
		);
	...
	************************************************************************/
	MRESULT ASFFaceFeatureCompare(
		...
		ASF_CompareModel		compareModel = ASF_CompareModel::ASF_LIFE_PHOTO	// [in] ASF_LIFE_PHOTO：用于生活照之间的特征比对
